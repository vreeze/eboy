...
(setq eboy-cpu
      (list
       ...
       (lambda nil "0xF5 PUSH AF"
         (decf eboy-sp 2)
         (eboy-mem-write-short eboy-sp
                               (eboy-get-rpair eboy-rA
                                               (eboy-flags-to-byte eboy-flags)))
         (incf eboy-clock-cycles 16))
       (lambda nil "0xF6 OR #"
         (assert nil t "unimplemented opcode")
         (incf eboy-clock-cycles 8))
